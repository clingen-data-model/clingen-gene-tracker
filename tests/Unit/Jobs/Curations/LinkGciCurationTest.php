...
class LinkGciCurationTest extends TestCase
{
    ...
    public function setup():void
    {
        ...
        $this->parentAffiliation = factory(Affiliation::class)->create([
            'clingen_id' => '10104',
        ]);

        $this->childAffiliation = factory(Affiliation::class)->create([
            'clingen_id' => '49998',
            'parent_id' => $this->parentAffiliation->id,
        ]);

        $this->expertPanel = factory(ExpertPanel::class)->create([
            'affiliation_id' => $this->childAffiliation->id,
        ]);
        ...
        $this->gciCuration = factory(GciCuration::class)->create([
            ...
            'mondo_id' => 'MONDO:0044312',
            'moi_id' => 2,
            // GCI curation points to parent affiliation PK
            'affiliation_id' => $this->parentAffiliation->id,
        ]);
    }
        ...
        $ism = factory(IncomingStreamMessage::class)->create([
            ...
            'payload' => [
                ...
                "performed_by" => [
                    ...
                    "email" => 'buttefield',
                    "on_behalf_of" => [
                        "id" => $this->parentAffiliation->clingen_id,
                        "name" => $this->parentAffiliation->name
                    ]
                ],
