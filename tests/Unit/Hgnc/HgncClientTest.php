...
class HgncClientTest extends TestCase
{
     ...
     * @test
     */
    public function app_resolves_abstract_HgncClient_w_concrete_implementation(): void
    {
     ...
     * @test
     */
    public function throws_new_HttpNotFoundException_when_no_results_for_gene_symbol(): void
    {
     ...
     * @test
     */
    public function fetches_hgnc_record_by_symbol_by_gene_symbol(): void
    {
     ...
     * @test
     */
    public function throws_HttpUnexpectedResponseException_when_more_than_one_record_found_for_gene_symbol(): void
    {
     ...
     * @test
     */
    public function fetches_record_by_hgnc_id(): void
    {
        $json = file_get_contents(base_path('tests/files/hgnc_api/ht.json'));
        $hgncClient = $this->getClient([new Response(200, [], $json)]);
